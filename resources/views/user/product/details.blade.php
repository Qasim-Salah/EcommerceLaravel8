...
@section('content')
    ...
    {{--                                <a class="link-socail" href="#"><img src="{{$product->image}}" alt=""></a>--}}
    {{--                            </div>--}}
    ...
    {{--                                                        <img alt="" src="{{asset('assets/user/images/author-avata.jpg')}}" height="80" width="80">--}}
    ...
    {{--                                                <a href="{{route('user.details',$products->slug)}}" title="{{$products->name}}">--}}
    {{--                                                    <figure><img src="{{$products->image}}" width="214" height="214"--}}
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                    <div class="wrap-product-detail">
                        <div class="detail-media">
                            <div class="product-gallery">
                                <ul class="slides">
                                    @isset($slider_product)
                                        @foreach($slider_product as $slider_products)
                                            <li data-thumb="{{$slider_products->image}}">
                                                <img src="{{$slider_products->image}}" alt="{{$slider_products->name}}"/>
                                            </li>
                                        @endforeach
                                    @endisset
                                </ul>
                                        ...
                                        <div id="comments">
                                            ...
                                            <ol class="commentlist">
                                                <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1"
                                                    id="li-comment-20">
                                                    <div id="comment-20" class="comment_container">
                                                        <img alt="" src="{{asset('assets/user/images/author-avata.jpg')}}" height="80"
                                                             width="80">
                                                        <div class="comment-text">
                                                            <div class="star-rating">
                                    ...
                                    @foreach($popular_product as $products)
                                        <li class="product-item">
                                            <div class="product product-widget-style">
                                                <div class="thumbnnail">
                                                    <a href="{{route('user.details',$products->slug)}}" title="{{$products->name}}">
                                                        <figure><img src="{{$products->image}}" alt="{{$products->name}}">
                                                        </figure>
                                                    </a>
                                                </div>
                                                <div class="product-info">
                                                    <a href="{{route('user.details',$products->slug)}}"
                                                       class="product-name"><span>{{$products->name}}</span></a>
                                                    <div class="wrap-price" style="padding-top: 10px; padding-bottom: 10px;"><span
                            ...
                            <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
                                ...
                                @isset($related_product)
                                    @foreach($related_product as $related_products)
                                        <div class="product product-style-2 equal-elem ">
                                            <div class="product-thumnail">
                                                <a href="{{route('user.details',$related_products->slug)}}"
                                                   title="{{$related_products->name}}">
                                                    <figure><img src="{{$related_products->image}}" width="214"
                                                                 height="214"
                                                                 alt="{{$related_products->name}}"></figure>
                                                </a>
                                                <div class="group-flash">
                                                    <span class="flash-item new-label">new</span>
                                                </div>
                                            ...
                                            <div class="product-info">
                                                <a href="#"
                                                   class="product-name"><span>{{$related_products->name}}</span></a>
                                                <div class="wrap-price"><span
                                                        class="product-price">${{$related_products->regular_price}}</span></div>
                                            </div>
                                        </div>
                                    @endforeach
                                @endisset
