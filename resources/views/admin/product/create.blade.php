                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{route('admin.product.store')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 ">
                                    <input type="number" name="regular_price" placeholder="Regular Price"
                                           value="{{old('regular_price')}}" class="form-control input-md">
                                </div>
                                @error('regular_price')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 ">
                                    <input type="number" name="sale_price" placeholder="Sale Price"
                                           value="{{old('sale_price')}}" class="form-control input-md">
                                </div>
                                @error('sale_price')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 ">
                                    <input type="text" name="sku" placeholder="Sku" value="{{old('sku')}}" class="form-control input-md">
                                </div>
                                @error('sku')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 ">
                                    <input type="text" name="quantity" placeholder="quantity"
                                           value="{{old('quantity')}}" class="form-control input-md">
                                </div>
                                @error('quantity')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
