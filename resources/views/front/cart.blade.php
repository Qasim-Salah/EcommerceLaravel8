                                ...
                                <li class="pr-cart-item">
                                    ...
                                    <div class="product-name">
                                        <a class="link-to-product"
                                           href="{{route('front.details',$item->model->slug)}}">{{$item->model->name}}</a>
                                    </div>
                                    <div class="price-field produtc-price"><p class="price">${{$item->model->regular_price}}</p></div>
                                    <div class="quantity">
                                        <div class="quantity-input">
                                            <input type="text" name="product-quatity" value="{{$item->model->qty}}" data-max="120"
                                                   pattern="[0-9]*">
{{--                                            <a class="btn btn-increase" href="{{route('front.increaseQuantity',$item->model->id)}}"></a>--}}
{{--                                            <a class="btn btn-reduce" href="{{route('front.decreaseQuantity',$item->model->id)}}"></a>--}}
                                        </div>
                                    </div>
                                    <div class="price-field sub-total"><p class="price">${{$item->subtotal}}</p></div>
                                    <div class="delete">
                                        <a href="{{route('front.destroyQuantity',$item->model->id)}}" class="btn btn-delete" title="">
                ...
                <div class="summary">
                    ...
                    <div class="update-clear">
                        <a class="btn btn-clear" href="{{route('front.destroyAllQuantity')}}">Clear Shopping Cart</a>
