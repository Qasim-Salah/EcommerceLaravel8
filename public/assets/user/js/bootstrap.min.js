...
+function (t) {
    ...
    o.VERSION = "3.3.7", o.TRANSITION_DURATION = 150, o.DEFAULTS = {
        ...
        var i = this.tip(), n = i[0].offsetWidth, s = i[0].offsetHeight, r = parseInt(i.css("margin-top"), 10),
        ...
        var p = /top|bottom/.test(o), c = p ? 2 * h.left - n + l : 2 * h.top - s + d, f = p ? "offsetWidth" : "offsetHeight";
        ...
        var s = window.SVGElement && o instanceof window.SVGElement, r = i ? {top: 0, left: 0} : s ? null : e.offset(),
